...
describe('End-to-End Workflow Tests', () => {
  ...
  describe('Complete School Management Workflow', () => {
    ...
    it('should update entities and maintain relationships', async () => {
      ...
      const testClass = await classCollection.add({ name: 'Original Class', gradeId: grade.id });
      const student = await studentCollection.add({ name: 'Original Student', classId: testClass.id, gradeId: grade.id });
